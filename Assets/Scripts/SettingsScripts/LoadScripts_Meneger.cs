...
public class LoadScripts_Meneger : MonoBehaviour
{
    ...
    public void LoadBinds(KeyBindsNames[] kbn)
    {
        ...
        LoadedSettings.attack = kbn[8].bind;
        LoadedSettings.mute = kbn[27].bind;
        LoadedSettings.forward = kbn[0].bind;
        LoadedSettings.right = kbn[2].bind;
        LoadedSettings.left = kbn[3].bind;
        LoadedSettings.back = kbn[1].bind;
        LoadedSettings.run = kbn[4].bind;
        LoadedSettings.jump = kbn[5].bind;
        LoadedSettings.dash = kbn[6].bind;
        LoadedSettings.teleport = kbn[7].bind;
        LoadedSettings.take = kbn[9].bind;
        LoadedSettings.drop = kbn[10].bind;
        LoadedSettings.inventory1 = kbn[11].bind;
        LoadedSettings.inventory2 = kbn[12].bind;
        LoadedSettings.inventory3 = kbn[13].bind;
        LoadedSettings.inventory4 = kbn[14].bind;
        LoadedSettings.inventory5 = kbn[15].bind;
        LoadedSettings.inventory6 = kbn[16].bind;
        LoadedSettings.inventory7 = kbn[17].bind;
        LoadedSettings.inventory8 = kbn[18].bind;
        LoadedSettings.inventory9 = kbn[19].bind;
        LoadedSettings.inventory0 = kbn[20].bind;
        ...
        LoadedSettings.escape = kbn[21].bind;
